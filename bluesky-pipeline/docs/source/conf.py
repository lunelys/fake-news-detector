...
# bluesky_pipeline documentation build
...
from bluesky_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "bluesky_pipeline"
author = "Kedro"
...
htmlhelp_basename = "bluesky_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "bluesky_pipeline.tex",
        "bluesky_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "bluesky_pipeline",
        "Project bluesky_pipeline codebase.",
        "Data-Science",
    )
]
